...
import { Activity, Globe, Lightbulb, Radar, Users, Zap } from 'lucide-react'
  ...
  return (
    <section className='relative overflow-hidden'>
      ...
      <div className='pointer-events-none absolute inset-0'>
        ...
        <div
          className='absolute right-1/4 top-10 h-[400px] w-[400px] translate-x-1/2 rounded-full bg-chart-2/6 blur-[100px] animate-pulse-glow'
          style={{ animationDelay: '2s' }}
        />
        <div
          className='absolute bottom-0 left-1/2 h-[300px] w-[600px] -translate-x-1/2 rounded-full bg-chart-4/5 blur-[80px] animate-pulse-glow'
      ...
      <div className='relative mx-auto max-w-7xl px-4 pb-8 pt-12 sm:px-6 sm:pt-16'>
        ...
        <div className='mb-10 flex flex-col items-center text-center'>
          ...
          <p className='mt-3 max-w-2xl text-pretty text-sm text-muted-foreground sm:text-base'>
            Detecting emerging narratives and early signals within the Solana
            ecosystem.
          </p>
        </div>
        ...
        <div className='grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6'>
          {stats.map((stat) => (
            ...
            >
              <div
                className={`flex h-10 w-10 items-center justify-center rounded-lg ${stat.bgColor} ring-1 ${stat.ringColor} transition-transform group-hover:scale-110`}
              >
