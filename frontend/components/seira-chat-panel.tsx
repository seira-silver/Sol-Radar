...
export function SeiraChatPanel({
  ...
  return (
    <div className="fixed bottom-24 right-5 z-50 flex h-[600px] w-[420px] max-w-[calc(100vw-2.5rem)] flex-col overflow-hidden rounded-2xl border border-border/50 bg-card/95 shadow-2xl backdrop-blur-xl animate-in fade-in slide-in-from-bottom-4 duration-200">
      {/* Header */}
